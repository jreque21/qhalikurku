...
if ( $li_contador > 0 ) {
	// Redireccionar
	if($lb_form == true) {
		header("Location: ../vista/mae_especialista_editar.php?id_codigo=".$li_codigo."&id_msgRpta=".$ls_mensaje);
	} else {
...
// Invocar CRUD
$lb_result = $crud->fila_eliminar(DEF_TABLA_ESPECIALISTA, $array_campo_pk, $array_valor_pk);
...
if($lb_result == true) {
	...
	header("Location: ../vista/mae_especialista_editar.php?id_codigo=".$li_codigo);
}
