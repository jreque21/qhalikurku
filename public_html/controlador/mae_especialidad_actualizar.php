...
if(isset($_POST) && !empty($_POST)){
	...
	$lb_result = $crud->fila_actualizar(DEF_TABLA_ESPECIALIDAD, $array_campo_pk, $array_valor_pk, $array_campo, $array_valor);
	...
	if($lb_result == true) {
		...
		header("Location: ../vista/mae_especialidad_editar.php?id_codigo=".$_POST["id_codigo"]);
	}
