...
if ( $li_contador > 0 ) {
	// Redireccionar
	if($lb_form == true) {
		header("Location: ../vista/mae_usuario_editar.php?id_codigo=".$li_codigo."&id_msgRpta=".$ls_mensaje);
	} else {
		header("Location: ../vista/mae_usuario_lista.php?id_msgRpta=".$ls_mensaje);
	}
	return;
}
// ======================================= FIN PRE ELIMINAR =========================================== //
...
// Invocar CRUD
$lb_result = $crud->fila_eliminar(DEF_TABLA_USUARIO, $array_campo_pk, $array_valor_pk);
...
if($lb_result == true) {
	...
	header("Location: ../vista/mae_usuario_editar.php?id_codigo=".$li_codigo);
}
