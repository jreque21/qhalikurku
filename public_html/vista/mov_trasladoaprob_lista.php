...
require_once(DEF_PATH_HTML_TRASLADO);
...
$array_valor_pk	= array(DEF_TABLA_TRASLADO_APROB);
...
f_listado_aprob($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta);
f_admin_pie();
