...
require_once(DEF_PATH_HTML_RPT_TRASLADOSPEND);
...
$array_valor_pk	= array(DEF_TABLA_RPT_TRASLADOSPEND);
...
f_listado($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $li_cod_sede);
f_admin_pie();
