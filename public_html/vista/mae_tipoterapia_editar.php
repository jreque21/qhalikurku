...
require_once(DEF_PATH_HTML_TIPOTERAPIA);
...
$array_valor_pk	= array(DEF_TABLA_TIPOTERAPIA);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_TIPOTERAPIA, $array_campo_pk, $array_valor_pk);
