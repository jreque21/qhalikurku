...
require_once(DEF_PATH_HTML_PROMOCIONADOEXT);
...
$array_valor_pk	= array(DEF_TABLA_PROMOCIONEXTPROG);
...
if ($id){
	...
	// Abrir formulario
	f_formulario_asistencia($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta, $id);
	
}
else
{
	f_listado_ejec($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta);
}
