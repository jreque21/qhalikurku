...
require_once(DEF_PATH_HTML_RPT_MATXHORARIO);
...
$array_valor_pk	= array(DEF_TABLA_RPT_MATXHORARIO);
...
f_listado($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $li_cod_sede, $li_cod_horario);
f_admin_pie();
