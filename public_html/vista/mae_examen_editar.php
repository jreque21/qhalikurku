...
require_once(DEF_PATH_HTML_EXAMEN);
...
$array_valor_pk	= array(DEF_TABLA_EXAMEN);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_EXAMEN, $array_campo_pk, $array_valor_pk);
