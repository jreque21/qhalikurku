...
require_once(DEF_PATH_HTML_TRATAMIENTO);
...
$array_valor_pk	= array(DEF_TABLA_TRATAMIENTO);
...
if (isset($_GET['id_cod_paciente_filtro'])) {
	$ls_paciente_filtro = $_GET["id_cod_paciente_filtro"];
}else{
	$ls_paciente_filtro = '';
}
...
f_listado($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta, $ls_paciente_filtro);
f_admin_pie();
f_admin_script('', '');
