...
require_once(DEF_PATH_HTML_ESPECIALIDAD);
...
$array_valor_pk	= array(DEF_TABLA_ESPECIALIDAD);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_ESPECIALIDAD, $array_campo_pk, $array_valor_pk);
