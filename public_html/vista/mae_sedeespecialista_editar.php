...
require_once(DEF_PATH_HTML_SEDEESPECIALISTA);
...
$array_valor_pk	= array(DEF_TABLA_SEDEESPECIALISTA);
...
if ($id){
	...
	$lb_result = $crud->ejecutar_sp("call sp_generar_sedeespecialista('$id','$ls_user')");
