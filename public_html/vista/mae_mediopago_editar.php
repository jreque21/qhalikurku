...
require_once(DEF_PATH_HTML_MEDIOPAGO);
...
$array_valor_pk	= array(DEF_TABLA_MEDIOPAGO);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_MEDIOPAGO, $array_campo_pk, $array_valor_pk);
