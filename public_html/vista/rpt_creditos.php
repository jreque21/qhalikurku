...
require_once(DEF_PATH_HTML_RPT_CREDITOS);
...
$array_valor_pk	= array(DEF_TABLA_RPT_CREDITOS);
...
f_listado($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $li_cod_sede, $li_cod_estudiante, $li_cod_estado);
f_admin_pie();
