...
require_once(DEF_PATH_HTML_EVENTOASISTENCIA);
...
$array_valor_pk	= array(DEF_TABLA_EVENTOPROG);
...
if ($id){
	...
	// Abrir formulario
	f_formulario_ejec($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta, $id);
