...
require_once(DEF_PATH_HTML_ESPECIALISTA);
...
$array_valor_pk	= array(DEF_TABLA_ESPECIALISTA);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_ESPECIALISTA, $array_campo_pk, $array_valor_pk);
