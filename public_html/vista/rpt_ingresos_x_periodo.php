...
require_once(DEF_PATH_HTML_RPT_INGXPERIODO);
...
$array_valor_pk	= array(DEF_TABLA_RPT_INGXPERIODO);
...
f_listado($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $li_cod_sede, $ldt_fini, $ldt_ffin);
f_admin_pie();
