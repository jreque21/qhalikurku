...
require_once(DEF_PATH_HTML_EVALUACION);
...
$array_valor_pk	= array(DEF_TABLA_EVALUACION);
...
f_listado_evaluacion($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta, $id_codigo);
f_admin_pie();
