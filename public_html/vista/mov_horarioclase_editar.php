...
require_once(DEF_PATH_HTML_HORARIOPROG);
...
$array_valor_pk	= array(DEF_TABLA_HORARIOPROG);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_HORARIOPROG, $array_campo_pk, $array_valor_pk);
