...
function f_listado($as_titulo, $as_icono, $as_msgRpta){
	...
	// Enlaces
	$url_nuevo		= "mov_promocion_nuevo.php";
	$url_editar		= "mov_promocion_editar.php";
	$url_lista		= "mov_promocion_lista.php";
	$url_prog		= "mov_promocionado_lista.php";
	$url_rpt_promocionados	= "Report/rpt_promo_promocionados.php";
	$url_rpt_graduados	= "Report/rpt_promo_graduados.php";
	$url_eliminar	= "../controlador/mov_promocion_eliminar.php";
											...
											while ($row = mysqli_fetch_assoc($array)) {
												...
												<tr>
													...
													<a href="<?php echo $url_prog_fila?>">
														<i class="fa fa-calendar-check-o" title = "Programar Promocionados"></i>
													</a>&nbsp;
...
function f_formulario($as_titulo, $as_icono, $as_msgRpta, $array = "") {
	...
	// Enlaces
	$url_lista		= "mov_promocion_lista.php";
	$url_registrar	= "../controlador/mov_promocion_registrar.php";
	$url_actualizar	= "../controlador/mov_promocion_actualizar.php";
	$url_eliminar	= "../controlador/mov_promocion_eliminar.php";
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<select class="form-control" id="id_cod_sede" name="id_cod_sede" required autofocus>
												<?php
...
function f_listado_promocionados($as_titulo, $as_icono, $as_msgRpta, $id_codigo_padre){
	...
	// Enlaces
	$url_cancelar = "mov_promocion_lista.php";
	...
	// Listado
	$array = $crud->fila_listar(DEF_TABLA_PROMOCIONPROG, $array_campo_pk, $array_valor_pk, 'N_COD_ESTUDIANTE', 'A', 0, 100);
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item active" aria-current="page"><b>Promoción : </b><?php echo $ls_subtitulo;?></li>
				</ol>
			</nav>
			<ol class="breadcrumb">
				<li><a href="<?php echo DEF_URL_LOGIN;?>"><i class="fa fa-home"></i> Inicio</a></li>
