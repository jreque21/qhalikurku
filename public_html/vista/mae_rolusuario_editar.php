...
require_once(DEF_PATH_HTML_ROLUSUARIO);
...
$array_valor_pk	= array(DEF_TABLA_ROLUSUARIO);
...
if ($id){
	...
	$lb_result = $crud->ejecutar_sp("call sp_generar_rolusuario('$id','$ls_tipouser','$ls_user')");
