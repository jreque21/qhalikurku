...
require_once(DEF_PATH_HTML_RPT_CUADREINGRESOS);
...
$array_valor_pk	= array(DEF_TABLA_RPT_CUADREINGRESOS);
...
if(isset($_POST) && !empty($_POST)){
	...
	$ldt_fecha	 	= $bd->bd_escapeCadena($_POST['id_fecha']);
}else{
	$li_cod_sede = '0';
	$ldt_fecha 	 = date('Y-m-d');
}
...
f_listado($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $li_cod_sede, $ldt_fecha);
f_admin_pie();
