...
function f_listado($as_titulo, $as_icono, $as_msgRpta){
	...
	// Enlaces
	$url_nuevo		= "mae_especialista_nuevo.php";
	$url_editar		= "mae_especialista_editar.php";
	$url_lista		= "mae_especialista_lista.php";
	$url_prog		= "../controlador/mae_especialista_usuario.php";
	$url_eliminar	= "../controlador/mae_especialista_eliminar.php";
	...
	// Listado
	$array = $crud->fila_listar(DEF_TABLA_ESPECIALISTA, $array_campo_pk, $array_valor_pk, 'V_APE_PATERNO, V_APE_MATERNO, V_NOMBRES', 'A', 0, 100);
									...
									<table id="lista" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											while ($row = mysqli_fetch_assoc($array)) {
												$url_editar_fila   = $url_editar."?id_codigo=".($row["N_COD_ESPECIALISTA"]);
												$url_prog_fila	   = $url_prog."?id_codigo=".($row["N_COD_ESPECIALISTA"]);
												$url_eliminar_fila = $url_eliminar."?id_codigo=".($row["N_COD_ESPECIALISTA"]);
												?>
												<tr>
													<?php

													echo "<td>";
													echo f_r_url($url_editar_fila, $row["N_COD_ESPECIALISTA"],$row["V_NOMBRES"]);
													echo "</td>";
													...
													$array_valor_pk	= array(DEF_TIPOUSER_ESP, $row["N_COD_ESPECIALISTA"], '1');
													...
													echo "<td align='center'>";
													?>
													<a href="#deleteModal<?php echo $row["N_COD_ESPECIALISTA"]; ?>" data-toggle="modal" ><i class="fa fa-trash-o"></i></a>
													<div id="deleteModal<?php echo $row["N_COD_ESPECIALISTA"]; ?>" class="modal fade">
...
function f_formulario($as_titulo, $as_icono, $as_msgRpta, $array = "") {
	...
	// Enlaces
	$url_lista		= "mae_especialista_lista.php";
	$url_registrar	= "../controlador/mae_especialista_registrar.php";
	$url_actualizar	= "../controlador/mae_especialista_actualizar.php";
	$url_eliminar	= "../controlador/mae_especialista_eliminar.php";
							...
							<form  id="form_mtto" role="form" method="post" action="" enctype="multipart/form-data" autocomplete="ofF">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="id_codigo" name="id_codigo" maxlength="5" disabled
														title = "Generado por el sistema" placeholder="Codigo autogenerado" value="<?php echo $lb_edit?$array["N_COD_ESPECIALISTA"]:""; ?>">
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
									...
									<div class="col-sm-4 text-center">
										<div class="form-group">			
											<?php if($lb_edit){
												...
												<img class="img-responsive img-thumbnail" src="../../upload/<?php echo DEF_UPLOAD_ESPECIALISTA_DIR.'/'.$array["V_FOTO"];?>" width="160px">
												<?php
												}	
											}?>
										</div>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<div class="form-group">
													<label for="id_cod_especialidad">Especialidad</label>
													<select class="form-control" id="id_cod_especialidad" name="id_cod_especialidad" required>
														<?php
														
														// Recuperando datos para combo
														$array_campo_pk	= array('V_FLAG_ESTADO');
														$array_valor_pk	= array('1');
														$array_tipo     = $crud->fila_listar(DEF_TABLA_ESPECIALIDAD, $array_campo_pk, $array_valor_pk, 'N_COD_ESPECIALIDAD', 'A', 0, 100);

														// Mostrando combo
														echo "<option value='' selected disabled hidden>Seleccione opción</option>";
														while ($this_tipo = mysqli_fetch_assoc($array_tipo)) {
															echo "<option value=\"";
															echo $this_tipo["N_COD_ESPECIALIDAD"];
															echo "\"";
															// Si existen registros, ponerlo en el combo
															if ($lb_edit && $this_tipo["N_COD_ESPECIALIDAD"] == $array["N_COD_ESPECIALIDAD"]){
																echo " selected";
															}
															echo ">";
															echo $this_tipo["V_DES_CORTA"];
								...
								<div class="row">
								    ...
								    <div class="col-sm-4">
								        <div class="form-group">
    								        <label for="id_colegiatura">Colegiatura</label>
        									<input type="text" class="form-control" id="id_colegiatura" name="id_colegiatura" maxlength="150"pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s0-9 -_]{1,150}"
        										title = "Letras y Números. Tamaño máximo: 150" placeholder="Ejemplo : CIP1234" value="<?php echo $lb_edit?$array["V_COLEGIATURA"]:""; ?>">
    									</div>
								    </div>    
								</div>
								...
								<?php
								if ($lb_edit) {
									echo "<input type=hidden name=id_codigo value=\"".$array["N_COD_ESPECIALISTA"]."\">";
									?>
