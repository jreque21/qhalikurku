...
require_once(DEF_PATH_HTML_FORMAPAGO);
...
$array_valor_pk	= array(DEF_TABLA_FORMAPAGO);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_FORMAPAGO, $array_campo_pk, $array_valor_pk);
