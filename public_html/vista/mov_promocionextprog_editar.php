...
require_once(DEF_PATH_HTML_PROMOCIONEXT);
...
$array_valor_pk	= array(DEF_TABLA_PROMOCIONEXT);
...
if ($id){
	...
	$lb_result = $crud->ejecutar_sp("call sp_generar_progpromocionext('$id','$ls_user')");
	
	// Abrir formulario
	f_formulario_prog($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta, $id);
