...
require_once(DEF_PATH_HTML_RPT_CITAS);
...
$array_valor_pk	= array(DEF_TABLA_RPT_CITAS);

// Recuperar registro
$array_opcion = $crud->fila_recuperar(DEF_TABLA_MENU_OPC, $array_campo_pk, $array_valor_pk);

// Capturar filtros (por defecto: mes actual, todos los especialistas)
...
f_reporte($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_fec_ini, $ls_fec_fin, $ls_cod_especialista);
f_admin_pie();
f_admin_script('', '');
