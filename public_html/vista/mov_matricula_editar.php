...
require_once(DEF_PATH_HTML_MATRICULA);
...
$array_valor_pk	= array(DEF_TABLA_MATRICULA);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_MATRICULA, $array_campo_pk, $array_valor_pk);
