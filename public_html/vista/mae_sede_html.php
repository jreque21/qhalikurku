...
function f_listado($as_titulo, $as_icono, $as_msgRpta){
	...
	// Enlaces
	$url_nuevo		= "mae_sede_nuevo.php";
	$url_editar		= "mae_sede_editar.php";
	$url_lista		= "mae_sede_lista.php";
	$url_eliminar	= "../controlador/mae_sede_eliminar.php";
									...
									<table id="lista" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											while ($row = mysqli_fetch_assoc($array)) {
												...
												$url_eliminar_fila = $url_eliminar."?id_codigo=".($row["N_COD_SEDE"]);
												?>
												<tr>
													<?php

													echo "<td>";
													echo f_r_url($url_editar_fila, $row["N_COD_SEDE"],$row["V_NOMBRE"]);
													echo "</td>";
													...
													echo "<td align='center'>";
													?>
													<a href="#deleteModal<?php echo $row["N_COD_SEDE"]; ?>" data-toggle="modal" ><i class="fa fa-trash-o"></i></a>
													<div id="deleteModal<?php echo $row["N_COD_SEDE"]; ?>" class="modal fade">
...
function f_formulario($as_titulo, $as_icono, $as_msgRpta, $array = "") {
	...
	// Enlaces
	$url_lista		= "mae_sede_lista.php";
	$url_registrar	= "../controlador/mae_sede_registrar.php";
	$url_actualizar	= "../controlador/mae_sede_actualizar.php";
	$url_eliminar	= "../controlador/mae_sede_eliminar.php";
							...
							<form  id="form_mtto" role="form" method="post" action="" enctype="multipart/form-data" autocomplete="off">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="id_codigo" name="id_codigo" maxlength="5" disabled
										title = "Generado por el sistema" placeholder="Codigo autogenerado" value="<?php echo $lb_edit?$array["N_COD_SEDE"]:""; ?>">
								</div>
								
								<div class="form-group">
									<label for="id_nombre">Nombre Sede</label>
									<input type="text" class="form-control" id="id_nombre" name="id_nombre" maxlength="150" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s0-9 ]{1,150}" autofocus
										title = "Letras y Números. Tamaño máximo: 150" placeholder="(*) Ejemplo : Sede Nueva York" value="<?php echo $lb_edit?$array["V_NOMBRE"]:""; ?>">
								</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="id_referencia" name="id_referencia" maxlength="150" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s0-9 -_()]{1,150}"
										title = "Letras y Números. Tamaño máximo: 150" placeholder="Ejemplo : Al costado de municipio" value="<?php echo $lb_edit?$array["V_DIRECCION"]:""; ?>">
								</div>
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="id_fono" name="id_fono" maxlength="20" pattern="[0-9 -_()]{1,20}"
												title = "Letras y Números. Tamaño máximo: 20" placeholder="Ejemplo : 4399999" value="<?php echo $lb_edit?$array["V_FONO"]:""; ?>"> 
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label for="id_movil">Movil</label>
											<input type="text" class="form-control" id="id_movil" name="id_movil" maxlength="20" pattern="[0-9 -_()]{1,20}"
												title = "Letras y Números. Tamaño máximo: 20" placeholder="Ejemplo : 999999999" value="<?php echo $lb_edit?$array["V_MOVIL"]:""; ?>"> 
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									title = "Letras, Números y carácteres de email. Tamaño máximo: 80" placeholder="Ejemplo : jperez@empresa.com" value="<?php echo $lb_edit?$array["V_EMAIL"]:""; ?>">
								</div>
								...
								<div class="form-group">
									...
									<?php if($lb_edit){
										...
										<img class="img-responsive img-thumbnail" src="../../upload/<?php echo DEF_UPLOAD_SEDE_DIR.'/'.$array["V_FOTO"];?>" width="150px">
										<?php
										}	
									}?>
								</div>
								...
								<?php
								if ($lb_edit) {
									echo "<input type=hidden name=id_codigo value=\"".$array["N_COD_SEDE"]."\">";
									?>
